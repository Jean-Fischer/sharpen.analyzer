...
public sealed class
    UseNullCoalescingAssignmentOperatorInsteadOfAssigningResultOfTheNullCoalescingOperatorAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void AnalyzeCoalesceExpression(SyntaxNodeAnalysisContext context)
    {
        ...
        if (assignment.Left is IdentifierNameSyntax identifierName &&
            identifierName.Parent is AssignmentExpressionSyntax
            {
    ...
    private static bool IsSideEffectFree(SyntaxNodeAnalysisContext context, ExpressionSyntax expression,
        bool isTopLevel)
    {
