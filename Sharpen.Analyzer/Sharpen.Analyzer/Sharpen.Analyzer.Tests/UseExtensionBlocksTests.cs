...
using VerifierCodeFix = Sharpen.Analyzer.Tests.Infrastructure.CSharp13CodeFixVerifier<
    Sharpen.Analyzer.Analyzers.CSharp14.UseExtensionBlocksAnalyzer,
    Sharpen.Analyzer.FixProvider.CSharp14.UseExtensionBlocksCodeFixProvider>;
...
static class Extensions
{
    extension(string s)
    {
        public int A() => s.Length;

        public int B() => s.GetHashCode();
    }
