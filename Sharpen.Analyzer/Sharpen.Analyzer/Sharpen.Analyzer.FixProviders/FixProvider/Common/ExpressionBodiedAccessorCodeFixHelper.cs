...
internal static class ExpressionBodiedAccessorCodeFixHelper
{
    internal static Task<Document> UseExpressionBodyForGetAccessorAsync<TAncestor>(
        ...
        => UseExpressionBodyAsync<TAncestor>(
            document,
            accessor,
            cancellationToken,
            SyntaxKind.GetAccessorDeclaration,
            getExpressionFromAccessor: static a =>
    ...
    internal static Task<Document> UseExpressionBodyForSetAccessorAsync<TAncestor>(
        ...
        => UseExpressionBodyAsync<TAncestor>(
            ...
            getExpressionFromAccessor: static a =>
            {
                ...
                if (a.Body.Statements.Count != 1)
                {
                    return null;
                }

                if (a.Body.Statements[0] is not ExpressionStatementSyntax expressionStatement)
                {
                    return null;
                }
            ...
            additionalAccessorListPredicate: null);
        ...
        where TAncestor : SyntaxNode
    {
        ...
        if (additionalAccessorListPredicate != null && !additionalAccessorListPredicate(accessorList))
        {
            return document;
        }
